...
public enum ActionQuotes {
    ...
    NORMAL_SLAP("**%s** is slapping **%s**!", "Geez, that should have hurt!"),
    SELF_SLAP("**%s** is... Slapping themself?", "What's wrong with them?"),
    AYAYA_SLAP("Oww! Why have you done that, baka! <:AngryAya:331115100771450880> *Slaps you back.*", null),
    DEV_SLAP("Hey! Don't you dare slapping my creator! <:AngryAya:331115100771450880>", null),
    ...
    SELF_SCOLD("**%s** is... Scolding themself?", "What's wrong with them?"),
    ...
    SELF_HIGHFIVE("**%s** is... Highfiving themself?", "That's weird."),
    ...
    SELF_TEEHEE("**%s** is... teasing themself?", "Weird."),
    ...
    SELF_POKE("**%s** is... poking themself?", "That's weird."),
    AYAYA_POKE("Nani?", null),
    NORMAL_BAKA("**%s** says that **%s** is a baka!", "Whoa!"),
    SELF_BAKA("**%s** admitted they are a baka!", "That's kawaii."),
    ...
    AYAYA_WAKEUP("Ohiyour... :sleepy: What time is it?", null),
    ...
    SELF_KISS("**%s** is... kissing themself?", "How weird!"),
    ...
    SELF_THROW("**%s** is... throwing something at themself?", "What's wrong with them?"),
    AYAYA_THROW("Hey! Be careful with what you're doing, okay?!", null),
    DEV_THROW("Don't you dare throwing anything at my creator, you baka! <:AngryAya:331115100771450880>", null),
    ...
    SELF_NUZZLE("**%s** is... nuzzling with themself?", "So weird."),
