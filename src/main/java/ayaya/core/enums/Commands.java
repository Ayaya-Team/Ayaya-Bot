...
public enum Commands {
    ...
    POUT(new Pout()), PREMIUM(new Premium()), PRUNE(new Prune()), QUOTE(new Quote()), RATE(new Rate()),
    ROLE(new Role()), ROLEINFO(new Roleinfo()), ROLL(new Roll()), RPS(new RPS()), SAY(new Say()),
