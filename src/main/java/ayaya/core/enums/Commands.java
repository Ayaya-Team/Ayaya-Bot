...
public enum Commands {
    ...
    KISS(new Kiss()), LAUGH(new Laugh()), MUTE(new Mute()), NEWS(new News()), NOM(new Nom()), NUZZLE(new Nuzzle()),
    PAT(new Pat()), PING(new Ping()), PRIVACY_POLICY(new PrivacyPolicy()), NSFW(new NSFW()), POKE(new Poke()),
    POUT(new Pout()), PREMIUM(new Premium()), PRUNE(new Prune()), RATE(new Rate()), ROLE(new Role()),
    ROLEINFO(new Roleinfo()), ROLL(new Roll()), RPS(new RPS()), SAY(new Say()), SERVERINFO(new Serverinfo()),
    SCARED(new Scared()), SCOLD(new Scold()), SHRUG(new Shrug()), SLAP(new Slap()), SLEEP(new Sleep()),
    SMILE(new Smile()), SNUGGLE(new Snuggle()), STARE(new Stare()), STATS(new Stats()), SUPPORT(new Support()),
    TEEHEE(new Teehee()), THROW(new Throw()), THUMBUP(new ThumbUp()), TICKLE(new Tickle()), TIME(new Time()),
    TSUNDERE(new Tsundere()), UNFLIPTABLE(new Unfliptable()), UNMUTE(new Unmute()), USERINFO(new Userinfo()),
    WAKEUP(new Wakeup());
