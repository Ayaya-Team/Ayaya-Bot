...
public enum CommandAliases {
    ...
    PFP("pfp", new Avatar()), PURGE("purge", new Prune()),
    REGIONALTEXT("regionaltext", new Bigtext()), SHRUGS("shrugs", new Shrug()),
    STATISTICS("statistics", new Stats()), TABLEFLIP("tableflip", new Fliptable()),
    TSUN("tsun", new Tsundere()), UNFLIP("unflip", new Unfliptable()), WAA("waa", new Cry()),
    WHAT("what", new Confused());
