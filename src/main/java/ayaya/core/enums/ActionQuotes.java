...
public enum ActionQuotes {
    ...
    SELF_PAT("Feeling lonely? Take a pat! " + Emotes.SLIGHT_SMILE_EMOTE, "I hope that made you feel better. ^^"),
    AYAYA_PAT("W-Why are you patting me? " + Emotes.EMBARASSED_EMOTE, null),
    NORMAL_HUG("**%s** is hugging **%s**!", "How adorable!!"),
    SELF_HUG("Feeling lonely? Take a hug! " + Emotes.SLIGHT_SMILE_EMOTE,
            "Hey, don't make up any ideas in your mind about this."),
    AYAYA_HUG("H-Hey, what are you doing? " + Emotes.EMBARASSED_EMOTE, null),
    ...
    AYAYA_SLAP("Oww! Why have you done that, baka! " + Emotes.ANGER_EMOTE + " *Slaps you back.*", null),
    DEV_SLAP("Hey! Don't you dare slap my creator! " + Emotes.ANGER_EMOTE, null),
    ...
    AYAYA_STARE("W-W-Why are you s-staring at me like that?! " + Emotes.EMBARASSED_EMOTE, null),
    ...
    AYAYA_HIGHFIVE("Highfive! " + Emotes.SLIGHT_SMILE_EMOTE + " *Highfives*", null),
    ...
    AYAYA_BAKA("I'm not a baka! " + Emotes.POUT_EMOTE, null),
    DEV_BAKA("Don't call my developer a baka! You are the baka! " + Emotes.ANGER_EMOTE, null),
    ...
    AYAYA_KISS("W-W-What are you doing?! BAKA! " + Emotes.EMBARASSED_EMOTE, null),
    ...
    DEV_THROW("Don't you dare throw anything at my creator, you baka! " + Emotes.ANGER_EMOTE, null),
    NORMAL_CONFUSED("**%s** is confused!", "Somebody help them!"),
    NORMAL_THUMBUP("**%s** is showing their thumb to **%s**!", "They seem to be doing fine. :)"),
    AYAYA_THUMBUP("Glad to know you're good. " + Emotes.SLIGHT_SMILE_EMOTE, null),
    ...
    AYAYA_NUZZLE("What are you doing? " + Emotes.EMBARASSED_EMOTE, null),
    ...
    AYAYA_SNUGGLE("W-Wha?! What are you doing?! " + Emotes.EMBARASSED_EMOTE, null),
    NORMAL_BITE("**%s** is biting **%s**!", null),
    SELF_BITE("**%s** is... biting themselves?", "What's wrong with them?!"),
    AYAYA_BITE("Oww! What's wrong with you?! " + Emotes.ANGER_EMOTE, null),
    DEV_BITE("Hey! Don't you dare bite my creator, you baka! " + Emotes.ANGER_EMOTE, null),
